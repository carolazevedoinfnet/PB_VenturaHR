...
<div class="container-fluid" style="margin-top:80px">
  ...
  <div class="card" style="width:200px">
    ...
    <p class="card-text">Projeto de Bloco: Engenharia Disciplinada</p>
      <a href="https://github.com/carolazevedoinfnet/PB_VenturaHR.git" class="btn btn-primary btn-sm">GIT</a>
